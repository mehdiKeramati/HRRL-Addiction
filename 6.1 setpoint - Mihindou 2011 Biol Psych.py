...
def plotSetpoint():
    ...
    pylab.xlim(( -11000 , trialsPerDay*10 + 11000))
...
pretrainingHours    = 0
sessionsNum         = 10                                  # Number of sessions of cocain seeking, followed by rest in home-cage
seekingHoursShA     = 0            
seekingHoursLgA     = 0            
extinctionHours     = 0
...
totalTrialsNum      = sessionsNum * (trialsPerDay+3)   #+ extinctionTrialsNum*2 + 1
...
for animal in range(0,animalsNum):
    ...
    for session in range(0,sessionsNum):
        ...
        noncontingentInfusion (  session  , cocaine*2 , 'LgA'   )
        noncontingentInfusion (  session  , cocaine*4 , 'LgA'   )
        noncontingentInfusion (  session  , cocaine*8 , 'LgA'   )
