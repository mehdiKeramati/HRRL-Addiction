...
def plotInternalStateLastSession():
    ...
    S1 = ax1.plot(internalStateLgA [ 0 : 500 ] , linewidth = 2.5 , color='black' )
    ...
    ax1.set_title('')
    fig1.savefig('High Dose-Other Models.eps', format='eps')
...
cocaine                 = 80             # Dose of self-administered drug
setOutcome    (0,1,1,cocaine)        
initialSetpoint         = 140
initializeAnimal        (   )
