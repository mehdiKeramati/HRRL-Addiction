...
S0 = ax1.plot(t,infusionPerDoseHigh , 'o-', ms=8, markeredgewidth =1.5, alpha=1, mfc='black',linewidth = 2 , color='black' )
S1 = ax1.plot(t,infusionPerDoseLow  , 'o-', ms=8, markeredgewidth =1.5, alpha=1, mfc='white',linewidth = 2 , color='black' )


leg=fig1.legend((S1, S0), ('D2R-Low','D2R-High'), loc = (0.50,0.6))
